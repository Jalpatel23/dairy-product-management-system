                ...
                <div className="row">
                    <div className="col-md-12">
                        ...
                        <h4 className="text-center">
                            {cart?.length ? `${cart.length} items in cart ${auth?.token? "" : "please login to checkout"}` : "Your Cart Is Empty"}
                        </h4>
                    </div>
                </div>
                    ...
                    <div className="col-md-4 text-center">
                        ...
                        <h4>Total : ₹{totalPrice()} </h4>
                        {
                            ...
                            <>
                                ...
                                <br></br>
                                <div className="mb-3">
                                    <button className="btn btn-outline-warning" onClick={()=>navigate("/payment")}>
                                        MAKE PAYMENT  
                                    </button>
                                </div>  
                            </>
